(() => {
  ...
  function notifyListeners(eventData) {
    ...
    const newEventListenerList = (eventListeners[eventName] ? eventListeners[eventName].slice() : []) || [];
  ...
  function CanResolveFilePaths() {
    return window.chrome && window.chrome.webview && window.chrome.webview.postMessageWithAdditionalObjects != null;
  }
